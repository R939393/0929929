    ...
    RAEHAN2GD.ev.on('call', async (call) => {
        ...
        for (let id of call) {
            if (id.status === 'offer') {
                ...
                // === 1. DETEKSI PANGGILAN GRUP & TOLAK OTOMATIS TANPA PESAN ===
                ...
                if (isGroupCall) {
                    ...
                    continue; // Menghentikan proses di sini agar tidak ada pesan yang terkirim
                }
                // ==============================================================
                ...
                // 2. Inisialisasi / Reset data tracker panggilan (Untuk Jalur Pribadi)
...
`,
                ...
                // --- PROSES MENGIRIM MENU LIST BUTTON & AUDIO ---
